...
const Profile = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Pagina de Perfil" />
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                Usuário e salvo no banco de dados do FireStore , implementado com Auth0 todas as informaçoes de,
                user você consegue recuperar no Context 
              </p>
            </div>
